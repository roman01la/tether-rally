...
void build_decode_matrix_into_space(const fec_t *restrict const code,
                                    ...
                                    const unsigned k, gf *restrict const matrix)
{
    unsigned short i;
    gf *p;
